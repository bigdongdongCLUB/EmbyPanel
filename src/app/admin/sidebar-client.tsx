  ...
  return (
    <aside className={(collapsed ? "w-16" : "w-60") + " fixed inset-y-0 left-0 bg-[rgb(17,17,17)] text-white flex flex-col z-30"}>
      ...
      <nav className="flex-1 p-2 text-sm">
        ...
        <div className="my-3 border-t border-[rgb(41,41,41)]" />
      ...
      <div className="p-3 border-t border-[rgb(41,41,41)] text-xs text-white/65 text-center">{collapsed ? (username || "U").slice(0, 1) : username}</div>
    </aside>
  );
}
