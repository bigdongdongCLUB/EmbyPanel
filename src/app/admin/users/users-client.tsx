    ...
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button className="border rounded px-3 py-2" disabled title="后续做邀请链接/短信/邮件">
            邀请用户
          </button>
          <button className="border rounded px-3 py-2" disabled title="后续扩展更多操作">
            更多
          </button>
        </div>
      </div>
        ...
        <table className="min-w-[1100px] w-full text-sm">
          <thead className="text-left text-gray-600 border-b">
            <tr>
              ...
              <th className="py-2 px-3">服务分配</th>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg w-full max-w-lg p-4">
            <div className="flex items-center justify-between">
              <div className="font-semibold">创建用户</div>
